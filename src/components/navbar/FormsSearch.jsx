...
export default function FormsSearch({ t }) {
  ...
  return (
    <div className="flex flex-col w-1/4 lg:w-1/3 items-center" ref={searchRef}>
      <div className="relative w-full">
        <div className="border border-gray-700 dark:border-gray-600 bg-background dark:bg-background-dark text-text dark:text-text-dark p-2 w-full flex items-center gap-3 px-4 rounded-full h-10 shadow-sm transition-all duration-300 ease-in-out focus-within:border-pink-500 focus-within:ring-2 focus-within:ring-pink-500">
          <FontAwesomeIcon
          ...
          <input
            ...
            className="border-none outline-none w-full bg-transparent text-sm lg:text-base placeholder-gray-500 dark:placeholder-gray-400 focus:ring-0"
            value={searchText}
            onChange={(e) => {
